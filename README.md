...
| Answer a permission or question at the console | **Verified**                                              | Terminal.app: keystroke path, needs Accessibility and the window in front; other hosts unsupported | **Unsupported** — the card sends you to the terminal instead    |
