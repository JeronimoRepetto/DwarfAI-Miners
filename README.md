...
| Answer a permission or question at the console | **Verified**                                              | Terminal.app: permission and single-select answers written into the session's tab; multi-select still keystrokes (Accessibility, window in front); other hosts unsupported | **Unsupported** — the card sends you to the terminal instead    |
