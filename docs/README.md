...
| ------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| [`guide.md`](guide.md)                                 | Every screen and control of the app in depth — the README's long form: the panel's areas, the message panel and delivery marks, attaching images and files, sound, settings, tray behaviour, the Claude hooks channel, provider limits, and the full configuration reference.                                                              |
...
| [`console-hosting.md`](console-hosting.md)             | Whether the panel can be the console. The four paths that were considered, what shipped from the one that won, and — in §4b — the delivery-channel matrix: which tier a message and an interrupt each take, why the console-versus-relay order reversed twice, and how a message reaches a console by process id rather than by keystroke. |
