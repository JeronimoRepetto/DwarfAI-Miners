...
export const INTERIOR_STATIONS: readonly InteriorStation[] = [
  { id: 'spawn-1', kind: 'spawn', x: 44.54, y: 22.5, facesLeft: false },
  { id: 'spawn-2', kind: 'spawn', x: 9.73, y: 37.13, facesLeft: false },
  { id: 'spawn-3', kind: 'spawn', x: 38.97, y: 90.44, facesLeft: false },
  { id: 'worker-1', kind: 'worker', x: 43.77, y: 10.02, facesLeft: false },
  { id: 'worker-2', kind: 'worker', x: 59.42, y: 11.07, facesLeft: false },
  { id: 'worker-3', kind: 'worker', x: 14.05, y: 14.89, facesLeft: true },
  { id: 'worker-4', kind: 'worker', x: 84.92, y: 15.62, facesLeft: false },
  { id: 'worker-5', kind: 'worker', x: 61.83, y: 24.94, facesLeft: false },
  { id: 'worker-6', kind: 'worker', x: 30.99, y: 34.81, facesLeft: false },
  { id: 'worker-7', kind: 'worker', x: 14.08, y: 42.44, facesLeft: true },
  { id: 'worker-8', kind: 'worker', x: 82.88, y: 51.95, facesLeft: false },
  { id: 'worker-9', kind: 'worker', x: 28.94, y: 53.17, facesLeft: true },
  { id: 'worker-10', kind: 'worker', x: 16.15, y: 55.59, facesLeft: true },
  { id: 'worker-11', kind: 'worker', x: 66.18, y: 65.75, facesLeft: true },
  { id: 'worker-12', kind: 'worker', x: 48.48, y: 68.69, facesLeft: true },
  { id: 'worker-13', kind: 'worker', x: 82.9, y: 69.77, facesLeft: false },
  { id: 'worker-14', kind: 'worker', x: 14.08, y: 70.5, facesLeft: true },
  { id: 'worker-15', kind: 'worker', x: 22.52, y: 83.62, facesLeft: true },
  { id: 'worker-16', kind: 'worker', x: 74.58, y: 84.35, facesLeft: true },
  { id: 'worker-17', kind: 'worker', x: 50.96, y: 91.09, facesLeft: false },
  { id: 'worker-18', kind: 'worker', x: 68.24, y: 92.07, facesLeft: true },
  { id: 'foreman-1', kind: 'foreman', x: 56.87, y: 47.7, facesLeft: false },
  { id: 'foreman-2', kind: 'foreman', x: 68.21, y: 49.02, facesLeft: true },
  { id: 'foreman-3', kind: 'foreman', x: 61.92, y: 52.53, facesLeft: true },
  { id: 'ladder-1', kind: 'ladder', x: 80.93, y: 25.28, facesLeft: true },
  { id: 'ladder-2', kind: 'ladder', x: 21.74, y: 26.49, facesLeft: false },
  { id: 'ladder-3', kind: 'ladder', x: 80.97, y: 40.89, facesLeft: true },
  { id: 'ladder-4', kind: 'ladder', x: 80.9, y: 63.28, facesLeft: true },
  { id: 'ladder-5', kind: 'ladder', x: 82.02, y: 79.16, facesLeft: false },
  { id: 'ramp-1', kind: 'ramp', x: 48.52, y: 33.49, facesLeft: false },
  { id: 'ramp-2', kind: 'ramp', x: 41.8, y: 47.74, facesLeft: false },
  { id: 'ramp-3', kind: 'ramp', x: 35.7, y: 62.33, facesLeft: false },
  { id: 'ramp-4', kind: 'ramp', x: 31.23, y: 78.17, facesLeft: false }
]
