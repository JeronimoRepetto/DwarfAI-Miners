...
describe('extractAntigravityFeed', () => {
   ...
   * `tool_calls` is the model deciding rather than speaking, and `thinking` is
   * a field of its own — so no tag-stripping heuristic is needed anywhere here.
   */
  it('shows no tool output, no bare tool call and no thinking', () => {
